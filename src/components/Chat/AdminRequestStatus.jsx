...
export default function AdminRequestStatus({ userRole }) {
  ...
  if (!selectedRequest || (userRole !== 'admin' && userRole !== 'ADMIN')) return null;
  ...
  return (
    <div style={{ marginLeft: 18, display: 'flex', alignItems: 'center', gap: 8 }}>
      ...
      <select
        ...
        disabled={loading}
        style={{ fontSize: 15, padding: '4px 10px', borderRadius: 6, border: '1.5px solid #ffe067', background: '#fffbe6', color: '#bfa600', fontWeight: 600 }}
      >

        ...
        <div className="clothing-vote-modal-content">
          {category && (
            <div className="category-info">
              ...
              <p>
                Show your interest in this collection. If enough people vote,
          ...
          <div className="vote-description">
            <p>
              🎯 <strong>Make it happen!</strong> Vote for this collection and
              help us decide which pieces to produce next.
            </p>
            <p>

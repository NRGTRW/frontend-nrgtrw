...
const SEOHead = ({ 
  ...
  const defaultDescription = 'Premium fitness programs, high-quality clothing, and cutting-edge tech solutions. Transform your lifestyle with NRG.';
  const defaultImage = 'https://nrgtrw-images.s3.eu-central-1.amazonaws.com/vision.png';
  ...
  return (
    <Helmet>
      ...
      <meta name="keywords" content={keywords || 'fitness, lifestyle, clothing, tech, premium, transformation'} />

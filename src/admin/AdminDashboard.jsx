...
const AdminDashboard = () => {
  ...
  // Initialize activeTab from navigation state or default to 'users'
  const [activeTab, setActiveTab] = useState(() => {
    const dashboardTab = location.state?.dashboardTab;
    if (dashboardTab && ['users', 'waitlist', 'analytics', 'products', 'orders', 'system', 'activity', 'feedback'].includes(dashboardTab)) {
      return dashboardTab;
    }
    return 'users';
  });
    ...
    <div className="admin-dashboard">
      ...
      {activeTab === 'analytics' && (
        <div className="admin-card">
          ...
          <div className="admin-content">
            <p>For detailed analytics, please visit the dedicated analytics page.</p>
            <a href="/admin/analytics" className="admin-link">Go to Analytics →</a>
          </div>
        </div>
      )}
      ...
      {activeTab === 'products' && (
        <div className="admin-card">
          ...
          <div className="admin-content">
            <p>Create and manage products in the dedicated product management page.</p>
            <a href="/admin/create-product" className="admin-link">Create New Product →</a>
          </div>
        </div>
      )}
      ...
      {activeTab === 'orders' && (
        <div className="admin-card">
          ...
          <div className="admin-content">
            <p>Order management functionality is currently being developed.</p>
          </div>
        </div>
      )}
      ...
      {activeTab === 'system' && (
        <div className="admin-card">
          ...
          <div className="admin-content">
            <p>System health monitoring is currently being developed.</p>
          </div>
        </div>
      )}
      ...
      {activeTab === 'activity' && (
        <div className="admin-card">
          ...
          <div className="admin-content">
            <p>Activity logs functionality is currently being developed.</p>
          </div>
        </div>
      )}
      ...
      {activeTab === 'feedback' && (
        <div className="admin-card">
          ...
          <div className="admin-content">
            <p>Feedback management functionality is currently being developed.</p>
          </div>
        </div>
      )}

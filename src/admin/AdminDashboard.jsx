    ...
    <div className="admin-dashboard">
      ...
      >
        ...
        >
          ...
          >
            <button
              className={`dashboard-nav-dropdown-item${activeTab === "users" ? " active" : ""}`}
              style={{
                display: "flex",
                alignItems: "center",
                padding: "10px 18px",
            ...
            <button
              className={`dashboard-nav-dropdown-item${activeTab === "waitlist" ? " active" : ""}`}
              style={{
                display: "flex",
                alignItems: "center",
                padding: "10px 18px",
            ...
            <button
              className={`dashboard-nav-dropdown-item${activeTab === "analytics" ? " active" : ""}`}
              style={{
                display: "flex",
                alignItems: "center",
                padding: "10px 18px",
            ...
            <button
              className={`dashboard-nav-dropdown-item${activeTab === "products" ? " active" : ""}`}
              style={{
                display: "flex",
                alignItems: "center",
                padding: "10px 18px",
            ...
            <button
              className={`dashboard-nav-dropdown-item${activeTab === "orders" ? " active" : ""}`}
              style={{
                display: "flex",
                alignItems: "center",
                padding: "10px 18px",
            ...
            <button
              className={`dashboard-nav-dropdown-item${activeTab === "system" ? " active" : ""}`}
              style={{
                display: "flex",
                alignItems: "center",
                padding: "10px 18px",
            ...
            <button
              className={`dashboard-nav-dropdown-item${activeTab === "activity" ? " active" : ""}`}
              style={{
                display: "flex",
                alignItems: "center",
                padding: "10px 18px",
            ...
            <button
              className={`dashboard-nav-dropdown-item${activeTab === "feedback" ? " active" : ""}`}
              style={{
                display: "flex",
                alignItems: "center",
                padding: "10px 18px",
      ...
      {activeTab === "waitlist" && (
        <div className="admin-card">
          ...
          <div className="waitlist-stats">
              ...
              <div className="stats-grid">
                <div className="stat-item">
                  <span className="stat-number">
                    {waitlistStats.totalWaiting || 0}
                  </span>
                  <span className="stat-label">Waiting</span>
                </div>
                <div className="stat-item">
                  <span className="stat-number">
                    {waitlistStats.totalNotified || 0}
                  </span>
                  <span className="stat-label">Notified</span>
                </div>
                <div className="stat-item">
                  <span className="stat-number">
                    {waitlistStats.totalConverted || 0}
                  </span>
                  <span className="stat-label">Converted</span>
                </div>
                <div className="stat-item">
                  <span className="stat-number">
                    {waitlistStats.totalRemoved || 0}
                  </span>
            ...
            {waitlistStats.programStats &&
              waitlistStats.programStats.length > 0 && (
                <div className="stat-card">
                    ...
                    <tr key={entry.id}>
                      ...
                      <td>
                        <select
                          ...
                          value={entry.status}
                          onChange={(e) =>
                            handleWaitlistStatusChange(entry.id, e.target.value)
                          }
                        >
                ...
                <ul>
                  {analytics.topProducts &&
                    analytics.topProducts.map((product, index) => (
                      <li key={index}>
                        {product.name}: {product.count} sales
                      </li>
                    ))}
                </ul>
              </div>
          ...
          {dataLoading.products ? (
            ...
            <div className="admin-table-container">
              ...
              {products.length === 0 && (
                <div className="no-data">
                  <p>
                    No products found. Add new products from the product page.
                  </p>
                </div>
              )}
            </div>
          ...
          {dataLoading.system ? (
            ...
            <div className="system-health-grid">
              <div className="stat-card">
                ...
                <p
                  style={{
                    color: systemHealth.status === "ok" ? "green" : "red",
                  }}
                >
                  {systemHealth.status}
                </p>

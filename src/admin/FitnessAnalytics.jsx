                ...
                <tbody>
                  {subscriptions.map((subscription) => (
                    <tr key={subscription.id}>
                      ...
                      <td>
                        <span
                          className={`status-badge ${subscription.status === "CANCELLED" ? "cancelled" : "active"}`}
                        >
          ...
          <div className="activity-section">
            <div className="activity-grid">
                  ...
                  {analytics.recentActivity.purchases.map((purchase) => (
                    <div key={purchase.id} className="activity-item">
                      ...
                      <div className="activity-content">
                        <p>
                          <strong>{purchase.user.name}</strong> purchased{" "}
                          <strong>{purchase.program.title}</strong>
                        </p>
                        <small>
                          ${purchase.amount} •{" "}
              ...
              <div className="activity-card">
                ...
                <div className="activity-list">
                  {analytics.recentActivity.subscriptions.map(
                    (subscription) => (
                      <div key={subscription.id} className="activity-item">
                        <div className="activity-icon">🔄</div>
                        <div className="activity-content">
                          <p>
                            <strong>{subscription.user.name}</strong> started
                            subscription
                          </p>
                          <small>
                            {new Date(

  ...
  useEffect(() => {
    const handleContextMenu = (e) => {
      if (!userHasAccess() && activeTab !== "overview") {
        e.preventDefault();
        toast.warning(
          "🔒 Content is protected. Purchase to unlock full access.",
        );
      }
    };
        ...
        <div className="tab-content">
              ...
              <div className="overview-grid">
                ...
                <div className="overview-card">
                  ...
                  {equipment.length > 0 ? (
                    ...
                    <p>
                      Equipment requirements will be listed in the instructions.
                    </p>
                  )}
                </div>
                ...
                <div className="overview-card">
                  ...
                  <p>
                    ...
                    {program.duration || "To be determined"}
                  </p>
                  {/* Removed difficulty level display */}
                  <p>
                    <strong>Type:</strong> Fitness Program
                  </p>
                </div>
              </div>
            </div>
              ...
              >
                {program.instructions ? (
                  ...
                  <div className="no-content">
                    ...
                    <p>
                      Please check back soon or contact support for immediate
                      assistance.
                    </p>
                  </div>
                )}
                {!userHasAccess() && (
                  <div className="content-overlay">
                    ...
                    <div className="lock-message">
                      ...
                      <p>
                        Join the waitlist to get early access when this program
                        launches
                      </p>
                      <button
              ...
              >
                {program.explanationVideo ? (
                  ...
                  <div className="no-content">
                    ...
                    <p>
                      Please check back soon or refer to the instructions tab.
                    </p>
                  </div>
                )}
                {!userHasAccess() && (
          ...
          {activeTab === "content" && (
            <div className="content-tab">
              ...
              <div
                className="content-wrapper"
                ref={(el) => (contentRefs.current.content = el)}
              >
                {program.programText ? (
                  ...
                  <div className="no-content">
                    ...
                    <p>
                      Please check back soon or download the PDF if available.
                    </p>
                  </div>
                )}
                {!userHasAccess() && (
          ...
          <div className="access-modal" onClick={(e) => e.stopPropagation()}>
            <div className="access-modal-content">
              ...
              <div className="modal-body">
                <p>
                  This program is currently in waitlist mode. Join our exclusive
                  waitlist to get early access when it becomes available!
                </p>

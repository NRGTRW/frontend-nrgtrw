  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 text-center">
        <p className="text-sm text-gray-900/80 font-light">
...
export const Footer2 = ({ colors }) => {
  ...
  return (
    <footer 
      className="bg-[#c5a47f] py-16 text-white"
      style={{
        ...
        <nav className="flex justify-center gap-6 mb-6">
          {["Instagram", "LinkedIn", "Twitter"].map((item) => (
            <a
              key={item}
              href="#"
              className="text-sm uppercase hover:text-[#c5a47f] text-gray-900 transition-colors duration-300"
            >
              {item}
            </a>
          ))}
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-sm text-gray-900/80 max-w-2xl mx-auto mb-8">
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 text-center">
        ...
        <button className="px-8 py-3 border border-[var(--textLight)] dark:border-[var(--textDark)] text-gray-900 hover:bg-[var(--textLight)]/10 dark:hover:bg-[var(--textDark)]/10 transition-colors duration-300">
          Initiate Project
        </button>
      </div>
    </footer>
  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 text-center">
        ...
        <p className="text-xs text-gray-900/60 mt-6">

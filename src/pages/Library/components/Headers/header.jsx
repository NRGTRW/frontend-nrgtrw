...
export const Header1 = ({ isVisible, colors }) => {
  ...
  return (
    <header
      className={`relative w-full bg-white border-b border-gray-200 py-3 transition-all duration-300 ${
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <span className="text-xl font-playfair text-[#c5a47f] tracking-widest">
          LUXE
        </span>
        <nav className="flex gap-6">
          {[
            ...
            <a
              key={item.label}
              href={item.path}
              className="text-sm uppercase tracking-wider hover:text-[#c5a47f] text-gray-900 transition-colors"
            >
              {item.label}
            </a>
          ))}
        </nav>
        <button className="px-4 py-2 text-sm uppercase border border-[var(--primary)] dark:border-[var(--primaryDark)] text-[#c5a47f] hover:bg-[var(--primary)]/5 dark:hover:bg-[var(--primaryDark)]/5">
          Contact
        </button>
      </div>
    </header>
...
export const Header2 = ({ isVisible, colors }) => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <span className="text-2xl font-cormorant italic text-[#c5a47f]">
          Élan
        </span>
        <nav className="flex gap-6">
          {[
  ...
  return (
    ...
    >
      <Container className="flex justify-between items-center">
        <div className="text-xl font-medium text-[#c5a47f]">
          ÆTHERFIT
        </div>
        <nav className="flex gap-6">
          {[
  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        <h1 className="text-lg font-medium text-[#c5a47f]">
          FinanceMaster
        </h1>
        <nav className="flex gap-6">
          {[

...
export default function FeaturesNeumorphicV06({ 
  ...
  const density = 'compact'; // compact, regular, roomy
  const ornament = 'minimal'; // minimal, moderate, rich
  const ctaStyle = 'solid'; // solid, outline, ghost
  const typography = 'small'; // small, medium, large
  const motion = 'none'; // none, fade, slide

    ...
    <ChatProvider>
      <div style={{ display: 'flex', height: '100vh', background: '#f7f7f7' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          <div style={{ height: 56, background: '#fff', borderBottom: '1.5px solid #eee', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', padding: '0 24px', position: 'relative' }}>
            {isMobile && (
              <button
                onClick={() => setSidebarOpen(o => !o)}
                aria-label="Open sidebar"
                style={{ position: 'absolute', left: 16, top: 10, background: 'none', border: 'none', fontSize: 28, color: '#bfa600', cursor: 'pointer', zIndex: 4000 }}
              >
                ☰
              </button>
            )}

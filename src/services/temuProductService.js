...
export async function fetchTemuProduct(temuUrl) {
  ...
  return {
    ...
    description:
      "Step into timeless style with this ultra-soft ribbed turtleneck. Crafted for comfort, built to impress – whether it’s date night or a crisp morning stroll.",
    source: "temu",
    originalUrl: temuUrl,
    colors: [

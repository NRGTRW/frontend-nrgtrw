    ...
    const realVideos = [
      {
        ...
        thumbnail: 'https://nrgtrw-images.s3.eu-central-1.amazonaws.com/ppl.jpg',
      ...
      {
        id: 'fit2',
        videoUrl: 'https://nrgtrw-images.s3.eu-central-1.amazonaws.com/precisiongrowth.mp4',
        thumbnail: 'https://nrgtrw-images.s3.eu-central-1.amazonaws.com/precisiongrowth.jpg',
        title: 'Precision Growth Program',
        views: '1.8K',
        likes: '95',
        comments: '15',
        shares: '4',
        description: 'Lean bulking with the Precision Growth program. #bulking #fitness',
        duration: '00:25',
        createdAt: '2024-01-11T16:30:00Z'
      },
      {
        id: 'fit3',
        videoUrl: 'https://nrgtrw-images.s3.eu-central-1.amazonaws.com/shred6.mp4',
        thumbnail: 'https://nrgtrw-images.s3.eu-central-1.amazonaws.com/shred6.jpg',
...
export const getTrendingHashtags = () => {
  return [
    '#fitness', '#progress', '#motivation', '#tech', 
    '#development', '#coding', '#style', '#fashion', 
    '#evolution', '#vision', '#goals', '#consistency'
  ];
}; 
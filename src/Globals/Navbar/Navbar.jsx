  ...
  return (
    <header className="navbar">
      <div className="top-bar">
            ...
            >
              <button
                ...
                style={{
                  ...
                  alignItems: "center",
                  cursor: "pointer",
                  boxShadow: dashboardDropdownOpen
                    ? "0 4px 12px rgba(230,184,0,0.18)"
                    : "none",
              ...
              >
                ...
                <svg
                  ...
                  style={{
                    ...
                    transform: dashboardDropdownOpen
                      ? "rotate(180deg)"
                      : "rotate(0deg)",
                  }}
                >
        ...
        <div
          className={`right-container${isAdmin && isMobile ? " admin-mobile" : ""}`}
        >
      ...
      <ul ref={menuRef} className={`menu ${menuOpen ? "show" : ""}`}>
        ...
        <div className="menu-section">
          ...
          <li
            onClick={() => setClothingDetailsOpen((open) => !open)}
            style={{ cursor: "pointer", userSelect: "none" }}
          >
            Clothing Details
            <span className={`arrow${clothingDetailsOpen ? " open" : ""}`}>
              ▼
            </span>
          </li>
          <ul className={`collapsible${clothingDetailsOpen ? " open" : ""}`}>
            ...
            <li onClick={() => handleNavigation("/clothing-details")}>
              Clothing Details
            </li>
            ...
            <li onClick={() => handleNavigation("/design")}>Design</li>
          </ul>
        </div>
        ...
        <div className="menu-section">
          ...
          <li onClick={() => handleNavigation("/")} className="service-link">
            All Services
          </li>
          <li

...
export default function FeaturesGradientV01({ 
  ...
  const styles = getStyleClasses('gradient');
    ...
    if (layout === 'hero') {
      return (
        <div className="relative">
          <InteractiveBadge text="New" variant="gradient" />
            ...
            {metrics && metrics.length > 0 && (
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
                {metrics.map((metric, index) => (
                  <MetricBubble key={index} value={metric.value} label={metric.label} variant="gradient" />
                ))}
              </div>
            )}
          </div>
      ...
      return (
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <InteractiveBadge text="Featured" variant="gradient" />
      ...
      return (
        <div className="space-y-12">
          <div className="text-center max-w-3xl mx-auto">
            <InteractiveBadge text="Solutions" variant="gradient" />
      ...
      return (
        <div className="space-y-12">
          <div className="text-center max-w-4xl mx-auto">
            <InteractiveBadge text="Showcase" variant="gradient" />
            <h2 className={`${typographyClasses[typography]} font-light text-gray-900 mb-6`}>
              {title}
            </h2>
            {subtitle && (
